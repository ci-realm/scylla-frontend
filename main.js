...
var author$project$Main$init = {
	builds: _List_fromArray(
		[
			{duration: '10:00', id: 1, project: 'scylla', sha: 'asdfasdf', status: 'bar', time: '19:00'},
			{duration: '10:00', id: 2, project: 'scylla', sha: 'asdfasdf', status: 'bar', time: '19:00'},
			{duration: '10:00', id: 3, project: 'scylla', sha: 'asdfasdf', status: 'bar', time: '19:00'}
		])
};
...
var author$project$Main$dbg = mdgriffith$elm_ui$Element$explain(
	_Debug_todo(
		'Main',
		{
...
var author$project$Main$mapNavItem = function (item) {
	return A2(
...
var author$project$Main$mappedNavItems = A2(elm$core$List$map, author$project$Main$mapNavItem, author$project$Main$navItems);
...
var author$project$Main$recentBuilds = function (model) {
	return A2(
			...
			]),
		{
			columns: _List_fromArray(
				[
					{
					header: mdgriffith$elm_ui$Element$text('Build'),
					view: function (build) {
						return mdgriffith$elm_ui$Element$text(
							elm$core$String$fromInt(build.id));
					},
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Status'),
					view: function (build) {
						return mdgriffith$elm_ui$Element$text(build.status);
					},
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Project'),
					view: function (build) {
						return mdgriffith$elm_ui$Element$text(build.project);
					},
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('SHA'),
					view: function (build) {
						return mdgriffith$elm_ui$Element$text(build.sha);
					},
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Time'),
					view: function (build) {
						return mdgriffith$elm_ui$Element$text(build.time);
					},
					width: mdgriffith$elm_ui$Element$fill
				},
					{
					header: mdgriffith$elm_ui$Element$text('Duration'),
					view: function (build) {
						return mdgriffith$elm_ui$Element$text(build.duration);
					},
					width: mdgriffith$elm_ui$Element$fill
				}
				]),
...
var author$project$Main$container = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text('Scylla')
							])),
						A2(
						mdgriffith$elm_ui$Element$column,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								author$project$Main$mappedNavItems)
							]))
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Main$recentBuilds(model)
							]))
					]))
			]));
};
...
var author$project$Main$view = function (model) {
	return A2(
		...
		author$project$Main$container(model));
};
